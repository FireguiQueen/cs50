...
> Também podemos ver o mesmo resultado, mas usando potênciação desta vez. A maneira anterior é apenas uma forma de representar esta maneira de um jeito um pouco mais simples.
