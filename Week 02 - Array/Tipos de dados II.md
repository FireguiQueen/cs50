...
Os HDs são essenciais para preservar dados que não podem ser perdidos. São nos HDs onde nossos arquivos, jogos e sistema operacional residem, e por isso é deve ser um tipo de __armazenamento não volátil__ que mantém os dados intactos mesmo quando o dispositivo está desligado.
