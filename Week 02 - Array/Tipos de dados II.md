...
> A memória RAM foi feita para ser volátil, não haveria sentido ela desempenhar um papel diferente. Ela é apenas um meio para os nossos processadores terem um dado para leitura e armazenamento de dados. E sempre serão dados temporários, como por exemplo, deixar seu navegador aberto. 
